// app/(public)/informasi/galeri/page.tsx
...
export default async function GaleriPage({
  ...
  const [galeriList, total] = await Promise.all([
    prisma.galeri.findMany({
      ...
      take: PER_PAGE,
      select: {
        id: true, judul: true, deskripsi: true, tipe: true,
        url: true, thumbnail: true, tags: true, urutan: true, createdAt: true,
      },
    }),
    ...
    <main style={{ background: '#050D1A', minHeight: '100vh' }}>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          <Image
            src="/images/hero/panorama-laut.jpeg"
            alt=""
            fill
          ...
          <div
            className="absolute -top-40 left-1/2 -translate-x-1/2 w-175 h-100 rounded-full"
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-5">
            ...
            <form method="GET" action="/informasi/galeri" className="flex items-center gap-2 w-full sm:w-72">
              ...
              <button
                type="submit"
                className="px-4 py-2.5 rounded-xl text-xs font-bold transition-all hover:scale-105 active:scale-95"
        ...
        <div className="flex flex-wrap gap-2 mb-7">
          {[
            ...
            return (
              <Link
                key={value}
                href={buildUrl({ tipe: value, halaman: 1 })}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
            {galeriList.map((g, i) => (
              ...
              >
                ...
                {g.tipe === 'VIDEO' && (
                  <span
                    className="absolute top-2.5 right-2.5 flex items-center gap-1 text-[9px] font-black px-2 py-0.5 rounded-md tracking-wider uppercase"
                ...
                {i === 0 && !tipeParam && !queryParam && halaman === 1 && (
                  <span
                    className="absolute top-2.5 left-2.5 text-[9px] font-black px-2 py-0.5 rounded-md tracking-widest uppercase"
                    style={{ background: '#38BDF8', color: '#050D1A' }}
                  >
                    UNGGULAN
                  </span>
                ...
                .map((p, i) =>
                  p === 'ellipsis' ? (
                    ...
                    <Link
                      ...
                      style={{
                        background: p === halaman ? '#38BDF8' : 'rgba(255,255,255,0.06)',
