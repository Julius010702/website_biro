  ...
  if (list.length === 0) {
    return (
      <div className="text-center py-20">
        ...
        <p className="text-sm" style={{ color: '#F5A623' }}>Belum ada aplikasi tersedia.</p>
      </div>
    )
  }
    ...
    <div className="pb-16">
      ...
      <div className="relative max-w-5xl mx-auto px-14">
        ...
        <button
          ...
          style={{
            background: 'linear-gradient(160deg, rgba(13,71,161,0.55) 0%, rgba(8,26,62,0.85) 100%)',
              ...
              >
                ...
                >
                  {app.logo ? (
                    ...
                    <Monitor className="w-10 h-10" style={{ color: 'rgba(255,255,255,0.25)' }} />
                  )}
                </div>
                ...
                <div className="w-full text-center">
                  ...
                  {app.kategori && (
                    <p className="text-[10px] font-semibold mb-2" style={{ color: '#F5A623' }}>
                      {app.kategori}
                    </p>
                  )}
                  {app.deskripsi && (
      ...
      {/* Count */}
      <p className="text-center text-xs mt-3" style={{ color: '#F5A623' }}>
