    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-2xl p-6" style={{ background: 'white', border: '1px solid #DBEAFE' }}>
        ...
        <div className="text-sm text-slate-600 leading-relaxed space-y-3">
          ...
          <p>
            Pelayanan informasi publik dilaksanakan pada hari dan jam kerja: <strong>Sen-Kam: 08.00-16.00 (ist. 12.00-13.00) | Jum: 08.00-16.30 (ist. 11.30-13.20) WITA</strong>.
          </p>
        </div>
      </div>
